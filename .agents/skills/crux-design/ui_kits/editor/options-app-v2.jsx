...
const noteStyle2 = { fontFamily: "var(--font-sans)", fontSize: 13, lineHeight: 1.5, color: "var(--fg-muted)" };
const tagStyle2 = { display: "inline-block", fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--accent)", marginBottom: 6, letterSpacing: "0.04em" };
