...
const v3 = {
  wrap: { position: "absolute", inset: 0, display: "flex", justifyContent: "center", alignItems: "stretch", background: "var(--bg)", padding: 0 },
  panel: { width: "100%", borderLeft: "1px solid var(--border-subtle)", background: "var(--bg-panel)", display: "flex", flexDirection: "column", minHeight: 0, fontFamily: "var(--font-sans)", color: "var(--fg)", fontSize: 12, position: "relative" },
  ...
  composer: { borderTop: "1px solid var(--border-subtle)", padding: 14, display: "grid", gap: 9, flexShrink: 0 },
  ta: { width: "100%", minHeight: 58, borderRadius: 11, border: "1px solid var(--border)", background: "var(--bg)", color: "var(--fg)", padding: 9, font: "inherit", fontSize: 12, boxSizing: "border-box", resize: "none" },
};
const fBtn3 = { border: 0, background: "var(--accent)", color: "var(--accent-ink)", borderRadius: 10, padding: "9px 14px", fontFamily: "inherit", fontWeight: 700, fontSize: 12, cursor: "pointer", whiteSpace: "nowrap" };
  ...
  return (
    <div style={v3.wrap}><div style={v3.panel}>
      ...
      <div style={v3.composer}>
        <div style={{ display: "flex", alignItems: "center", gap: 7, fontSize: 11, color: "var(--fg-faint)", padding: "0 1px" }}>
          <span style={{ width: 5, height: 5, borderRadius: 999, background: "var(--accent)", flexShrink: 0 }} />
          <span>Finished? Use the <span style={{ color: "var(--accent-hover)", borderBottom: "1px solid var(--accent)", cursor: "pointer", fontWeight: 600 }}>▾ to send &amp; end</span> the session.</span>
        </div>
        <div style={v3.ta} />
...
function PanelDualHome() {
  return (
    <div style={v3.wrap}><div style={v3.panel}>
      ...
      <div style={{ position: "absolute", right: 12, top: 10, width: 210, background: "var(--bg-bar)", border: "1px solid var(--border)", borderRadius: 12, boxShadow: "var(--shadow-tooltip)", padding: 6, zIndex: 20 }}>
        <div style={{ padding: "6px 9px 7px" }}>
          ...
          <div style={{ fontFamily: "var(--font-mono)", fontSize: 10.5, color: "var(--fg-muted)" }}>landing/index.html</div>
        </div>
        <div style={{ height: 1, background: "var(--border)", margin: "2px 0 4px" }} />
        <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "7px 9px", borderRadius: 8, fontSize: 11, color: "var(--fg-muted)" }}>Reload artifact</div>
        <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "7px 9px", borderRadius: 8, fontSize: 11, color: "var(--fg-muted)" }}>Copy DOM snapshot</div>
        <div style={{ height: 1, background: "var(--border)", margin: "4px 0" }} />
        <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "7px 9px", borderRadius: 8, fontSize: 11, color: "var(--danger)", background: "rgba(240,100,100,.08)" }}><span style={{ display: "flex" }}><I3 d={ic3Exit} size={13} /></span>End session</div>
      </div>
    </div></div>
  );
}
    ...
    <div style={v3.wrap}><div style={v3.panel}>
      ...
      <div style={v3.composer}>
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", position: "relative" }}>
          ...
          <div style={{ position: "absolute", right: 0, bottom: 42, background: "var(--bg-bar)", border: "1px solid var(--border)", color: "var(--fg-muted)", borderRadius: 8, padding: "6px 9px", fontSize: 10.5, whiteSpace: "nowrap", boxShadow: "var(--shadow-tooltip)" }}>
            Send &amp; end session
            <span style={{ position: "absolute", right: 18, bottom: -5, width: 8, height: 8, background: "var(--bg-bar)", borderRight: "1px solid var(--border)", borderBottom: "1px solid var(--border)", transform: "rotate(45deg)" }} />
          </div>
        </div>
      </div>
    </div></div>
