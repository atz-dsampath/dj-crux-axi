...
const ns3 = { fontFamily: "var(--font-sans)", fontSize: 13, lineHeight: 1.5, color: "var(--fg-muted)" };
const ts3 = { display: "inline-block", fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--accent)", marginBottom: 6, letterSpacing: "0.04em" };
