...
function Artifact({
  ...
  }, "Crux opens an agent-generated HTML artifact in a local browser, lets you pinpoint elements, and ships your feedback back to the agent."), /*#__PURE__*/React.createElement(Anno, {
    id: "cta",
    tag: "button",
  ...
  }, /*#__PURE__*/React.createElement("span", null, "crux-axi \xB7 v0.1.0"), /*#__PURE__*/React.createElement("span", null, "~/projects/landing/index.html"))));
}
...
function WorkingBubble() {
  const workingStyles = {
    ...
    spinner: {
      ...
      animation: "crux-spin 0.8s linear infinite",
  ...
  const SplitMenuItem = ({
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        background: hover && !disabled ? danger ? "rgba(240,100,100,.10)" : "var(--border-subtle)" : "transparent",
...
function AnnotateSwitch({
  ...
  const s = {
    ...
    knob: {
      ...
      height: 16,
      borderRadius: 999,
      background: on ? "var(--accent-ink)" : "var(--fg-faint)",
...
function MenuItem({
  ...
  const base = {
    ...
    border: 0,
    cursor: "pointer",
    background: hover ? danger ? "rgba(240,100,100,.10)" : "var(--border-subtle)" : "transparent",
    color: danger ? "var(--danger)" : "var(--fg)"
  };
  return /*#__PURE__*/React.createElement("button", {
    type: "button",
...
function TopBar({
  ...
  const s = {
    ...
    moreBtn: {
      ...
      placeItems: "center",
      border: "1px solid",
      borderColor: menuOpen ? "var(--border-strong)" : "var(--border-subtle)",
      background: menuOpen ? "var(--border-subtle)" : "transparent",
    ...
    copyHint: {
      ...
      fontSize: 10,
      fontWeight: 600,
      color: copied ? "var(--accent-hover)" : "var(--fg-faint)",
      flexShrink: 0,
      display: "flex",
      alignItems: "center",
      gap: 4
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: s.brandMark
  }, "Crux"), /*#__PURE__*/React.createElement("span", {
...
function ArtifactBody() {
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: v2.artLede
  }, "Crux opens an agent-generated HTML artifact in a local browser, lets you pinpoint elements, and ships your feedback back to the agent."));
}
...
function ArtifactBody({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: mc.artLede
  }, "Crux opens an agent-generated HTML artifact in a local browser, lets you pinpoint elements, and ships your feedback back to the agent."), note);
}
