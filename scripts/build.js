...
await esbuild.build({
  ...
  target: "node22",
  define: {
    "process.env.CRUX_AXI_BUILD_UMAMI_HOST": JSON.stringify(process.env.CRUX_AXI_UMAMI_HOST || ""),
    "process.env.CRUX_AXI_BUILD_UMAMI_WEBSITE_ID": JSON.stringify(process.env.CRUX_AXI_UMAMI_WEBSITE_ID || ""),
    "process.env.CRUX_AXI_BUILD_VERSION": JSON.stringify(packageJson.version),
  },
});
