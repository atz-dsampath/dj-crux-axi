...
export function createArtifactSdk(
  ...
  function highlightElement(el) {
    if (!el) return;
    el.style.outline = "var(--crux-annotate-outline,3px solid #58cc02)";
  ...
  function ensureShadow() {
    ...
    style.textContent = `:host{all:initial;position:fixed;z-index:2147483647;left:0;top:0;color-scheme:dark;--canvas:#131f24;--polar-dark:#202f36;--orca-dark:#37464f;--koala-dark:#485a62;--hare-dark:#52656d;--eel-dark:#f1f7fb;--owl:#58cc02;--owl-dark:#93d333;--tree-frog:#58a700;--bg:var(--canvas);--bg-panel:var(--polar-dark);--bg-elevated:var(--orca-dark);--fg:var(--eel-dark);--fg-faint:var(--hare-dark);--border:var(--koala-dark);--accent:#93d333;--accent-hover:#9fe437;--accent-press:#58a700;--accent-ink:#131f24;--btn-depth:5px;--font-sans:Nunito,ui-rounded,"SF Pro Rounded",system-ui,-apple-system,sans-serif;--font-mono:"JetBrains Mono",ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;--radius-md:12px;--radius-xl:20px;--shadow-floating:0 20px 70px rgba(0,0,0,.35);font-family:var(--font-sans)}*{box-sizing:border-box}:focus-visible{outline:2px solid var(--accent);outline-offset:2px}.crux-text-highlight{position:fixed;pointer-events:none;background:rgba(88,204,2,.26);border-radius:3px;box-shadow:0 0 0 1px rgba(88,204,2,.5)}.crux-annotation-card{position:fixed;width:min(320px,calc(100vw - 24px));padding:12px;border-radius:var(--radius-xl);background:var(--bg-panel);color:var(--fg);border:1px solid var(--accent);box-shadow:var(--shadow-floating);font:14px/1.4 var(--font-sans)}.crux-heading{font-weight:700;margin-bottom:6px}.crux-annotation-card textarea{width:100%;min-height:86px;resize:vertical;border-radius:var(--radius-md);border:1px solid var(--border);background:var(--bg);color:var(--fg);padding:9px;font:inherit;font-family:var(--font-sans)}.crux-annotation-card textarea::placeholder{color:var(--fg-faint)}.crux-annotation-card .crux-hint{margin-top:6px;font-size:11px;color:var(--fg-faint)}.crux-annotation-card .crux-row{display:flex;gap:8px;justify-content:flex-end;margin-top:8px}.crux-annotation-card button{border:0;border-radius:var(--radius-md);padding:9px 12px;font-family:var(--font-sans);font-size:13px;font-weight:800;cursor:pointer;transition:filter 100ms,transform 60ms,box-shadow 60ms}.crux-annotation-card .crux-send{background:var(--accent);color:var(--accent-ink);box-shadow:0 var(--btn-depth) 0 var(--accent-press)}.crux-annotation-card .crux-send:hover{filter:brightness(1.08)}.crux-annotation-card .crux-send:active{transform:translateY(var(--btn-depth));box-shadow:0 0 0 var(--accent-press)}.crux-annotation-card .crux-cancel{background:var(--bg-elevated);color:var(--fg)}.crux-annotation-card .crux-cancel:active{opacity:.85}`;
