...
export const SKILL_DESCRIPTION =
  ...
  "annotate and send feedback on, using the crux-axi CLI. Use when about to give a plan, " +
...
/**
 * Render the installable SKILL.md for the crux skill. The body mirrors what
 * `crux-axi` prints with no arguments (minus live session state), while the
...
export function createSkillMarkdown() {
  const home = createHomeOutput({ bin: "crux-axi", sessions: [], includeSessions: false, agent: "static" });
